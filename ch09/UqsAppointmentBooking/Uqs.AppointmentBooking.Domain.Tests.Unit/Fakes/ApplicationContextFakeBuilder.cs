...
public class ApplicationContextFakeBuilder : IDisposable
{
    ...
    {
        _mensCut = _context.Add(
            new Service
            {
                Name = "Men's Cut",
                AppointmentTimeSpanInMin = min,
                Price = 23,
                IsActive = true,
            }
        );
    ...
    {
        _appointmentForPaulWithTom = _context.Add(
            new Appointment
            {
    ...
    public ApplicationContextFakeBuilder WithServices()
    {
        ...
        var mensClipperScissor = _context.Add(
            new Service
            {
        ...
        var mensBeardTrim = _context.Add(
            new Service
            {
                Name = "Men - Beard Trim",
